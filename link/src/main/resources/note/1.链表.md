    ...
    public ListNode detectCycle(ListNode head) {
        ...
        while(fastNode.next != null && fastNode.next.next != null){
            ...
            if(slowNode == fastNode){
                // 设置相遇节点
                ListNode contactNode = fastNode;
                // 设置头节点
                ListNode headNode = virtualNode.next;
                // 当两个节点再次相遇的时候，相遇节点就是入口节点
                while(contactNode != fastNode){
...
# 链表相交
1. 题目链接：[02.07. 链表相交](https://leetcode.cn/problems/intersection-of-two-linked-lists-lcci/)
2. 考察点：
```java
